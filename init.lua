...
vim.cmd("hi StatusLine   gui=NONE guifg=" .. colors.bg    .. " guibg=" .. colors.nc)
vim.cmd("hi StatusLineNC gui=NONE guifg=" .. colors.fg    .. " guibg=" .. colors.nc)
...
vim.cmd("hi NvimTreeCursorLine gui=NONE guifg=" .. colors.white .. " guibg=" .. colors.blue_bright)
